...
extern dwSoftISPHandle_t gSoftISP;
extern dwImageProperties gRGBProperties;
...
bool initPipeline(const dwImageProperties &rawImageProps, const dwCameraProperties &cameraProps, dwDriveNetHandle_t driveNet, dwContextHandle_t ctx);
